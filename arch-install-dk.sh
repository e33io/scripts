...
dunst gvfs nfs-utils cifs-utils rsync cronie git curl wget tar less 7zip base-devel xsel xclip \
playerctl dex mate-polkit upower xdg-desktop-portal-gtk xdg-user-dirs xbindkeys xdotool xwallpaper \
lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings lxappearance gnome-themes-extra gtk-engine-murrine \
