...
playerctl dex mate-polkit upower xdg-desktop-portal-gtk xdg-user-dirs xbindkeys xdotool lightdm \
...
yay -S --noconfirm --needed --sudoloop dk xssproxy adwaita-qt5-git adwaita-qt6-git mintstick brave-bin octopi
