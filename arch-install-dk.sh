...
rofi dunst base-devel upower gvfs nfs-utils cifs-utils libmad rsync cronie git curl wget tar less \
7zip xsel xclip xbindkeys xdotool playerctl dex xdg-desktop-portal-gtk xdg-user-dirs mate-polkit \
