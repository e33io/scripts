...
thunar-archive-plugin network-manager-applet ffmpegthumbnailer base-devel gvfs nfs-utils cifs-utils rsync \
cronie git curl wget tar 7zip less xsel xclip xdg-desktop-portal-gtk xdg-user-dirs xiccd xorg-apps wmctrl \
xdotool xbindkeys plymouth lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings gnome-themes-extra \
