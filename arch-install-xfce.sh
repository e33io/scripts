...
xbindkeys plymouth lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings gnome-themes-extra  qt5ct qt6ct \
ttf-dejavu noto-fonts-emoji papirus-icon-theme breeze-icons pavucontrol engrampa atril ristretto imv mpv parole \
rhythmbox mousepad galculator dconf-editor gnome-disk-utility timeshift xterm bash-completion vim nano micro \
