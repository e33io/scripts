...
sudo dnf -y install gnome-tweaks dconf-editor gnome-shell-extension-appindicator adwaita-gtk* gnome-themes-extra papirus-icon-theme htop fastfetch cava cmus perl-Image-ExifTool timeshift filezilla gimp darktable inkscape gcolor3
