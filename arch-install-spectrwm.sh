...
# =============================================================================
# Arch Linux - Install Spectrwm
# URL: https://github.com/e33io/scripts/blob/main/arch-install-spectrwm.sh
# -----------------------------------------------------------------------------
# Use this script at your own risk, it will overwrite existing files!
# Works best with a fresh "Minimal" archinstall (Profile > Type > Minimal)
# to install the spectrwm window manager and a base set of apps for a
...
sudo pacman -S --noconfirm --needed xorg-server xorg-apps i3lock xss-lock dmenu rofi dunst gvfs nfs-utils \
cifs-utils fuse rsync cronie git curl wget tar less 7zip base-devel xsel xclip playerctl dex mate-polkit upower \
xdg-desktop-portal-gtk xdg-user-dirs xbindkeys xdotool lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings \
...
echo "========================================================================"
echo "Install spectrwm and other packages from AUR"
echo "========================================================================"

yay -S --noconfirm --needed --sudoloop spectrwm xssproxy adwaita-qt5-git adwaita-qt6-git mintstick brave-bin octopi
...
cp -R $HOME/scripts/set-theming-spectrwm.sh $HOME/.local/bin/set-theming-spectrwm
echo "spectrwm was installed via e33io script: $(date '+%B %d, %Y, %H:%M')" \
