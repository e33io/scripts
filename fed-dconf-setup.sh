...
dconf write /org/gnome/shell/extensions/space-bar/appearance/custom-styles "'#panel.transparent-top-bar .panel-button {\n  text-shadow: 0px 1px 2px rgba(0, 0, 0, 0);\n}\n#panel.transparent-top-bar .system-status-icon,\n#panel.transparent-top-bar .app-menu-icon > StIcon,\n#panel.transparent-top-bar .popup-menu-arrow {\n  icon-shadow: 0px 1px 2px rgba(0, 0, 0, 0);\n}'"
dconf write /org/gnome/shell/extensions/space-bar/appearance/custom-styles-enabled "true"
...
dconf write /org/gnome/shell/extensions/space-bar/appearance/empty-workspace-text-color "'rgba(238,238,238,0.4)'"
