...
sudo apt -y install openbox xfce4-panel xfce4-pulseaudio-plugin xfce4-battery-plugin xfce4-docklike-plugin \
xfce4-windowck-plugin network-manager-gnome i3lock rofi dunst playerctl xssproxy xsel xclip xinput x11-utils \
lxappearance qt*ct adwaita-qt* gnome-themes-extra papirus-icon-theme breeze-icon-theme fonts-dejavu \
fonts-noto-color-emoji nitrogen mate-polkit-bin python3-gi gobject-introspection gir1.2-gtk-3.0 \
