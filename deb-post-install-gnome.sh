...
sudo apt -y install gnome-core gnome-tweaks gnome-shell-extension-manager adwaita-qt qgnomeplatform-qt5 papirus-icon-theme fonts-noto-color-emoji plymouth-themes file-roller rhythmbox synaptic mintstick firefox-esr gcolor3 darktable gimp inkscape filezilla libreoffice-calc libreoffice-draw libreoffice-impress libreoffice-writer libreoffice-gtk3 soundconverter timeshift dconf-editor heif-thumbnailer nfs-common cifs-utils libimage-exiftool-perl micro fzf htop neofetch cava cmatrix apt-transport-https curl xclip input-remapper-gtk
