...
sudo apt -y install jwm polybar i3lock rofi dunst dex network-manager wmctrl xdotool \
...
engrampa pipewire-audio pulseaudio-utils pavucontrol-qt synaptic timeshift mintstick scrot \
...
cp -R $HOME/core/debian/home/.[a-zA-Z]* $HOME/
