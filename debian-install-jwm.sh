...
sudo apt -y install jwm polybar network-manager i3lock rofi dunst playerctl xssproxy xsel \
xclip xinput x11-utils feh lxappearance qt*ct adwaita-qt* gnome-themes-extra papirus-icon-theme \
