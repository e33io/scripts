...
# ============================================================================
# Devuan Daedalus (post-install) Initial Setup
# URL: https://github.com/e33io/scripts/blob/main/devuan-post-install-setup.sh
# ----------------------------------------------------------------------------
...
#   cd scripts
#   sh devuan-post-install-setup.sh
# ============================================================================
...
if [ ! $release = daedalus ]; then
    echo "#########################################################"
    echo "Devuan Daedalus Initial Setup is NOT compatible with"
...
echo "#########################################################"
echo "Update Devuan Daedalus apt sources.list file"
echo "#########################################################"

echo "# Reference: https://www.devuan.org/os/packages.html
...
while true; do
    ...
    case $yn in
        [Yy]* ) sudo apt -t daedalus-backports -y install linux-image-amd64;
                if [ -d "/usr/share/doc/firmware-iwlwifi" ]; then
                    sudo apt -t daedalus-backports -y install firmware-iwlwifi
                fi
                break;;
