...
# URL: https://git.sr.ht/~e33io/scripts/tree/main/item/opensuse-post-install-i3.sh
# --------------------------------------------------------------------------------
