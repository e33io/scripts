...
network-manager-applet i3lock xss-lock rofi dunst base-devel upower gvfs nfs-utils cifs-utils libmad rsync \
cronie git curl wget tar less 7zip xsel xclip xbindkeys xdotool wmctrl playerctl dex xdg-desktop-portal-gtk \
