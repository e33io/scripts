...
# URL: https://github.com/e33io/scripts/blob/main/arch-install-openbox.sh
# -----------------------------------------------------------------------------
# Use this script at your own risk, it will overwrite existing files!
# Works best with a fresh "Minimal" archinstall (Profile > Type > Minimal)
# to install the Openbox window manager and a base set of apps for a
...
sudo pacman -S --noconfirm --needed xorg-server xorg-apps openbox lxappearance-obconf xfce4-panel \
xfce4-pulseaudio-plugin xfce4-battery-plugin xfce4-docklike-plugin xfce4-windowck-plugin \
network-manager-applet i3lock xss-lock rofi dunst gvfs nfs-utils cifs-utils rsync cronie git curl wget \
tar less 7zip base-devel xsel xclip playerctl dex mate-polkit upower xdg-desktop-portal-gtk xdg-user-dirs \
wmctrl xbindkeys xdotool lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings feh lxappearance \
gnome-themes-extra  qt5ct qt6ct ttf-dejavu noto-fonts-emoji papirus-icon-theme breeze-icons plymouth \
pavucontrol-qt kitty python-pillowfight xterm thunar thunar-archive-plugin thunar-volman tumbler \
ffmpegthumbnailer engrampa scrot atril imv mpv parole mousepad galculator timeshift bash-completion vim \
nano micro fzf lazygit htop fastfetch cmus cava ranger ueberzug highlight atool w3m mediainfo \
