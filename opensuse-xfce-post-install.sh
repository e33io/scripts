...
sudo zypper install xsel xinput xbindkeys xdotool xdpyinfo playerctl xf86-video-amdgpu nfs-client exfatprogs git opi qt5ct adwaita-qt5 gnome-themes-extras papirus-icon-theme words htop neofetch ranger micro-editor fzf cmus cava mpv engrampa atril flameshot darktable gimp inkscape libreoffice libreoffice-gtk3
