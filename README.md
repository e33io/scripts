...
- use the scripts below with an Ubuntu 24.04 Server installation
	...
	- use [`ubuntu-srvr-post-install-jwm.sh`](https://github.com/e33io/scripts/blob/main/ubuntu-srvr-post-install-jwm.sh) to [install the JWM window manager](https://github.com/e33io/reference-wiki/blob/main/installation-docs/ubuntu-jwm-installation.md)
...
- use [`install-brave-deb.sh`](https://github.com/e33io/scripts/blob/main/install-brave-deb.sh) to install the [Brave Browser](https://brave.com) (apt package)
...
- use [`install-signal-deb.sh`](https://github.com/e33io/scripts/blob/main/install-signal-deb.sh) to install [Signal App](https://www.signal.org) (apt package)
...
- use [`gnome-install-nemo-deb.sh`](https://github.com/e33io/scripts/blob/main/gnome-install-nemo-deb.sh) to replace Gnome Files App with Nemo on Debian
...
## other/testing
- scripts in [`temp`](https://github.com/e33io/scripts/blob/main/temp) directory are for testing purposes only
