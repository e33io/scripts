...
sudo pacman -S --noconfirm --needed xorg-server xorg-apps xfce4-panel xfce4-pulseaudio-plugin xfce4-docklike-plugin \
xfce4-windowck-plugin network-manager-applet i3lock xss-lock dmenu rofi dunst gvfs nfs-utils cifs-utils fuse rsync \
cronie git curl wget tar less 7zip base-devel xsel xclip playerctl dex mate-polkit xdg-desktop-portal-gtk \
xdg-user-dirs wmctrl xbindkeys xdotool lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings lxappearance-gtk3 \
gnome-themes-extra gtk-engine-murrine qt5ct qt6ct ttf-dejavu noto-fonts-emoji papirus-icon-theme breeze-icons \
plymouth pavucontrol-qt nitrogen kitty python-pillowfight xterm thunar thunar-archive-plugin thunar-volman tumbler \
ffmpegthumbnailer engrampa scrot atril imv mpv parole mousepad galculator dconf-editor gnome-disk-utility timeshift \
bash-completion vim nano micro fzf lazygit htop fastfetch cmus cava ranger ueberzug highlight atool w3m mediainfo \
perl-image-exiftool signal-desktop darktable gimp inkscape filezilla libreoffice
