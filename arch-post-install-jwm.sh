...
xsel xclip playerctl dex mate-polkit xdg-desktop-portal-gtk xdg-user-dirs wmctrl xbindkeys xdotool lightdm lightdm-gtk-greeter \
...
sed -i 's/yoffset: .*;/\/\* yoffset: ; \*\//' $HOME/.config/rofi/config.rasi
