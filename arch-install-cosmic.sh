...
xdg-user-dirs gvfs gvfs-nfs gvfs-smb nfs-utils cifs-utils rsync cronie git \
curl wget tar 7zip less base-devel bash-completion vim nano micro fzf lazygit htop \
fastfetch cmus cava ranger highlight atool w3m mediainfo perl-image-exiftool \
kitty python-pillowfight imv mpv timeshift gnome-disk-utility dconf-editor file-roller \
