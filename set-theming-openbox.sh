...
theming_files () {
    ...
    sed -i "s/xsetroot -solid \".*\"/xsetroot -solid \"$desktop_bg_color\"/" $HOME/.config/openbox/autostart
...
Mint_Blue_Dark () {
    # Openbox theme
    openbox_theme="Mint-Mod-Blue-Dark"
    # Theme accent color
    accent_color="#0c75de"
...
Mint_Green_Dark () {
    # Openbox theme
    openbox_theme="Mint-Mod-Green-Dark"
    # Theme accent color
    accent_color="#35a854"
...
Mint_Green_Light () {
    # Openbox theme
    openbox_theme="Mint-Mod-Green-Light"
    # Theme accent color
    accent_color="#35a854"
    accent_color_rgb="rgb(53,168,84)"
    # Desktop background color
...
Mint_Grey_Dark () {
    # Openbox theme
    openbox_theme="Mint-Mod-Grey-Dark"
    # Theme accent color
    accent_color="#8e9197"
...
Mint_Orange_Dark () {
    # Openbox theme
    openbox_theme="Mint-Mod-Orange-Dark"
    # Theme accent color
    accent_color="#ff7139"
...
Mint_Purple_Dark () {
    # Openbox theme
    openbox_theme="Mint-Mod-Purple-Dark"
    # Theme accent color
    accent_color="#8c5dd9"
...
Mint_Red_Dark () {
    # Openbox theme
    openbox_theme="Mint-Mod-Red-Dark"
    # Theme accent color
    accent_color="#e82127"
...
Mint_Teal_Dark () {
    # Openbox theme
    openbox_theme="Mint-Mod-Teal-Dark"
    # Theme accent color
    accent_color="#199ca8"
