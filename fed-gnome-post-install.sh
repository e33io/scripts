...
sudo dnf -y install gnome-tweaks dconf-editor gnome-shell-extension-appindicator adwaita-gtk* gnome-themes-extra papirus-icon-theme micro fzf htop fastfetch cava cmus perl-Image-ExifTool decibels timeshift filezilla gimp darktable inkscape gcolor3
