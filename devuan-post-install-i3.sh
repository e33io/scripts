...
# ===========================================================================
# Devuan (post-install) i3 Installation
# URL: https://github.com/e33io/scripts/blob/main/devuan-post-install-i3.sh
# ---------------------------------------------------------------------------
# Use this script at your own risk, it will overwrite existing files!
# Use with a minimal installation of Devuan Linux to install the i3 window
...
cp -R $HOME/opt-dots/devuan/.config $HOME
cp -R $HOME/opt-dots/devuan/.local $HOME
cp -R $HOME/opt-dots/devuan/.bashrc $HOME
