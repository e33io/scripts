...
sudo apt -y install jwm xfce4-panel xfce4-pulseaudio-plugin network-manager-gnome i3lock rofi dunst playerctl \
xssproxy xsel xclip xinput x11-utils lxappearance qt*ct adwaita-qt* gnome-themes-extra papirus-icon-theme \
