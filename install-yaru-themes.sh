...
sudo sed -i '/gtk-icon-sizes/d' /usr/share/themes/Yaru*/gtk-2.0/gtkrc
sudo sed -i '/gtk-menu/d' /usr/share/themes/Yaru*/gtk-2.0/gtkrc
sudo sed -i '/gtk-button/d' /usr/share/themes/Yaru*/gtk-2.0/gtkrc
sudo sed -i '/gtk-small-toolbar/d' /usr/share/themes/Yaru*/gtk-2.0/gtkrc
sudo sed -i '/gtk-dnd/d' /usr/share/themes/Yaru*/gtk-2.0/gtkrc
sudo sed -i '/gtk-dialog/d' /usr/share/themes/Yaru*/gtk-2.0/gtkrc
