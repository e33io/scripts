...
fuse rsync cronie git curl wget tar 7zip less base-devel ffmpegthumbnailer xsel xclip xdg-desktop-portal-gtk xdg-user-dirs xiccd xorg-apps \
wmctrl xdotool xbindkeys plymouth lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings gnome-themes-extra gtk-engine-murrine qt5ct \
