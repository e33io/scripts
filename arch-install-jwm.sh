...
base-devel upower gvfs nfs-utils cifs-utils rsync cronie git curl wget tar less 7zip xsel xclip \
xbindkeys xdotool wmctrl playerctl dex xdg-desktop-portal-gtk xdg-user-dirs mate-polkit lightdm \
