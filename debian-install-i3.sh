...
qt*ct adwaita-qt* gnome-themes-extra papirus-icon-theme breeze-icon-theme fonts-dejavu fonts-noto-color-emoji \
mate-polkit-bin python3-gi gobject-introspection gir1.2-gtk-3.0 libdbus-glib-1-2 upower lightdm \
...
fastfetch htop cmus cava cmatrix ncal micro ranger ueberzug caca-utils highlight atool w3m poppler-utils \
mediainfo fzf libimage-exiftool-perl apt-transport-https curl rsync xdotool xbindkeys xwallpaper
