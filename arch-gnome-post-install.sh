...
sudo pacman -S nautilus-python gnome-shell-extension-appindicator dconf-editor gnome-themes-extra papirus-icon-theme qt5ct qt6ct less nfs-utils micro fzf fastfetch cava cmus perl-image-exiftool timeshift ghostty signal-desktop filezilla gimp darktable inkscape gcolor3 libreoffice
